...
function residual = CounterFactualSystem(price_temp, cost, co2, tax_rate, fuel_cost, delta_np, num_manuf, alpha, beta, sigma, nu)
...
omega_tilde = (Temp_omega1-Temp_omega2);
